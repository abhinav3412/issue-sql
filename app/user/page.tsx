...
export default function UserDashboardPage() {
  ...
  const fetchServiceRequests = useCallback(async (isBackground = false) => {
    if (!isBackground) setServiceRequestsLoading(true);
    try {
      const url =
      ...
      if (!isBackground) setServiceRequestsLoading(false);
    }
  }, [user?.id]);
